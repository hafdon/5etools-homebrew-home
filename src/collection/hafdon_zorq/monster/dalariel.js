/**
 * based on {@monster marid|mm} cr11
 */
module.exports = {
    name: 'Dalariel',
    size: 'L',
    ...
    trait: [
        ...
        },
        {
            ...
            entries: [
                'If Dalariel dies, its body disintegrates into a burst of water and foam, leaving behind only equipment Dalariel was wearing or carrying.',
            ],
        },
    ],
    action: [
        ...
        },
        {
            ...
            entries: [
                "Dalariel chooses up to three creatures it can see within 30 feet of it. Until the end of Dalariel's next turn, each target can add a {@dice d4} to its attack rolls and saving throws.",
            ],
        },
    ],
    bonusAction: [
        {
            name: 'Recall Trident',
            entries: [
                'Dalariel can recall to her grasp her trident as long as it is no more than 80 feet away from her.',
            ],
        },
    ],
    ...
    spellcasting: [
        {
            ...
            headerEntries: [
                "Dalariel's innate spellcasting ability is Charisma (spell save DC 14, {@hit 6} to hit with spell attacks). It can innately cast the following spells, requiring no material components:",
            ],
            will: [
    ...
    //     ],
    // },
    tokenUrl: 'https://5e.tools/img/MM/Marid.png?v=1.94.8',
};
